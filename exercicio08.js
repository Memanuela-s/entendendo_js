let produto1 = prompt("informe o nome do produto1:");
let preço1 = parseFloat(prompt("infome o preço do produto1:"));

let produto2 = prompt("informe o nome do produto2:");
let preço2 = parseFloat(prompt("infome o preço do produto2:"));

let produto3 = prompt("informe o nome do produto3:");
let preço3 = parseFloat(prompt("infome o preço do produto3:"));
...
//* ou então if (preço1 <= preço2) { if (preço1 <= preço2)}*//
let info = 
' o produto ${produto1}'

//* fui acompanhar o professor na explicação */
